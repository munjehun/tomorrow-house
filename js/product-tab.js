...
//-------------------스크롤시 탭 활성화 성능개선 (IntersectionObserver 버전)-------------------
...
const options = {
  ...
  rootMargin:
    window.innerWidth >= 768
      ? `${-(TOP_HEADER_DESKTOP + 100)}px 0px 0px`
      : `-30% 0px -${ORDER_CTA_HEIGHT}px 0px`,
  threshold: [0, 0.3, 0.7, 1], //화면에서 보이는 정도가 아니라 요소의 보이는 정도를 나타낸다.
}
